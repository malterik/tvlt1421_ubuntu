...
then
   ...
   xrandr --output $DVIN --mode "1368x768_59.90" --right-of eDP1 #Set left of LVDS1 for X1's default monitor, if you use another monitor, change LVDS1 to match your monitor
else
